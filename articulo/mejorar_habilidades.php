<?php $titulo = "Mejorar mis habilidades";
$key1 = "mejorar habilidades de estudios"; $key2 = "habilidades desarrollo web"; $key3 = "motivacion desarrollo de software"; $key4 = "entuciasmo en programacion"; 
	...
	<div class="row justify-content-center ml-md-5">
	   ...
	   <div class="row justify-content-center">
	   	   <div class="col-12 col-md-7 mt-4">
	   	   	   <h3 class="text-center">¿Como puedo mejorar mis habilidades?</h3>
